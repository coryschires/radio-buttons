...
All shapes, such as lines, return an array of points that constitute the shape. This allows you to call methods on the entire shape at once. For example, let's draw a line and slowly move it east across the canvas:
