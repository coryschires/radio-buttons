...
Do keep in mind, however, that the radio button canvas is, well, low resolution. This means that lines short lines with gentle slopes don't work so well. For example:
...
I'll be improving this section as I continue to develop the API. If you're really eager to see how things work, I'd suggest having a look at the {unit tests}[https://github.com/coryschires/radio-buttons/tree/master/spec]. They do a fairly good job specifying the code.
