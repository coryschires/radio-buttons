...
The <tt>polygon</tt> function provides an easy way to create various such triangles, diamonds, and so on. Make a polygon by specifying in the vertices as arrays of coordinates:
